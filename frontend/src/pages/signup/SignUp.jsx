  ...
  <div className='flex flex-col ite just min-w-96 mx-auto'>
    ...
    bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
      <h1 className='text-3xl font-semibold text-center text-gray-300'>
        Sign Up <span className='text-blue-500'> ChatFil </span>
      </h1>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <input type='text' placeholder='Juan Dela Cruz' className='w-full input input-bordered h-10'
        ...
        <label className='label p-2'>
          ...
          <input type='text' placeholder='jdelacruz' className='w-full input input-bordered h-10'
        ...
        <Link className='text-sm hover:underline hover:text-blue-600 mt-4 inline-block'
        to={'/login'}>
